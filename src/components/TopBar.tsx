    ...
    <div className="bg-navy-dark border-b border-primary-foreground/[0.06]">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between py-2 px-4 text-[11px] gap-2 sm:gap-0">
        ...
        <div className="flex items-center gap-3">
          <a
            href="tel:0903400896"
            className="group relative flex items-center gap-2 pl-1 pr-3.5 py-1.5 rounded-full bg-gradient-to-r from-accent/20 to-accent/10 border border-accent/40 hover:border-accent/60 hover:from-accent/30 hover:to-accent/20 transition-all duration-300 shadow-[0_0_20px_-6px_hsl(var(--accent)/0.35)] hover:shadow-[0_0_28px_-4px_hsl(var(--accent)/0.5)]"
          >
            <span className="relative flex items-center justify-center w-6 h-6 rounded-full bg-success/20">
              <span className="absolute inline-flex h-2.5 w-2.5 rounded-full bg-success opacity-80 animate-ping" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-success" />
            </span>
            <Phone className="w-3 h-3 text-accent/80 -mr-0.5" />
            <span className="font-bold tracking-wide text-accent uppercase">Potrebujete poradiť?</span>
            <span className="text-primary-foreground font-extrabold text-sm tracking-wide">0903 400 896</span>
          </a>
