            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8 pt-14">
                <SmartImage
                  src={cat.image}
                  alt={cat.title}
                  wrapperClassName={`${cat.subtitle === "HIFU CONTLEX SENSE" ? "max-h-32" : "max-h-[60%]"} w-auto flex items-center justify-center`}
                  className={`${cat.subtitle === "HIFU CONTLEX SENSE" ? "max-h-32" : "max-h-full"} w-auto object-contain transition-all duration-700 group-hover:scale-110 drop-shadow-xl`}
                />
              </div>
